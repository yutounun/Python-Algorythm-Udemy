...
class LinkedList:
    ...
    def partition_list(self, x):
        """
        edge: length == 0, 1 / all values of nodes are greater or less than x
        """
        ...
        greater.next = None
        # Skip greater_ini whose value is 0 tempolary
        less.next = greater_ini.next
        return less_ini
