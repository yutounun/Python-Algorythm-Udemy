...
class LinkedList:
    ...
    def remove(self, index):
        """
        Edge case:
        1. Index arg points at out of the range
        """
        ...
        # # temp.next does exist since list is iterated index-1 times.
        # # even though temp.next.next doesn't exist, None can be assigned
